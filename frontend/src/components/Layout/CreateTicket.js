...
import { GET_SPRINTS, GET_SPRINTS_WITH_TASKS } from '../../graphql/queries';
...
const CreateTicket = ({ closeModal }) => {
    ...
    return (
        <form className='p-1' onSubmit={handleSubmit}>
            <div className="mb-4">
                <label className="block text-gray-700 mb-2 uppercase text-sm tracking-wide font-medium">Title</label>
                <input
                    type="text"
                    value={title}
                    onChange={(e) => setTitle(e.target.value)}
                    className="w-full bg-transparent border border-gray-300 rounded-md px-4 py-2 outline-none focus:ring focus:ring-blue-500"
            ...
            <div className="mb-4">
                ...
                <textarea
                    ...
                    className="w-full border border-gray-300 rounded-md px-4 py-2 outline-none focus:ring focus:ring-blue-500"

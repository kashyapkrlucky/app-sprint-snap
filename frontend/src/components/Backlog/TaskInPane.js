        ...
        <>
            ...
            <div className='flex flex-col gap-1'>
                ...
                <div className='flex flex-row gap-1 text-sm'>
                    ...
                    <span><DateFromNow value={task?.createdAt}></DateFromNow></span>
                </div>
                <div className='flex flex-row gap-1 text-sm'>
                    <span className='text-gray-600 w-24'>Updated</span>
                    <span><DateFromNow value={task?.updatedAt}></DateFromNow></span>
                </div>
            </div>

            <div className="flex flex-col gap-1">
                <h3 className='font-semibold text-xs'>Agile</h3>
                <div className='flex flex-row gap-1 text-sm'>
                    <span className="text-gray-600 w-24">Sprints:</span>
                    {task?.sprints.map(s => <span className="text-sm text-gray-800 mr-1" key={s?.id}>{s?.name}</span>)}
                </div>
            </div>

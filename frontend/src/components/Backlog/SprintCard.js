...
function SprintCard({ sprint, selectedProject, closeAction, updateSprint, createSprint }) {
                        ...
                        <div className='w-full flex flex-row justify-between items-center'>
                            ...
                            {sprint?.name !== 'Backlog' && <div className='flex flex-row gap-2 items-center'>
                                ...
                                }
                                {
                                    ...
                                    <button className='bg-gray-100 px-4 py-1 text-sm rounded'>Completed</button>
                                }
                            </div>}
                        </div> :
